...
## 순차 탐색(Linear Search)
<img src="https://velog.velcdn.com/images/zz1996zz/post/cc310c83-5702-4b66-a962-35ef547986d5/image.gif">
...
## 이진 탐색(Binary Search)
<img src="https://velog.velcdn.com/images/mutedlemon/post/149233ed-e8f6-4aec-a9e0-343b9837db76/image.gif">

- 이진 탐색은 탐색 범위를 반으로 쪼개면서 데이터를 탐색하는 알고리즘이다.
- 이진 탐색을 사용하려면 sorting 된 리스트에서 사용해야한다.

### 특징
- Linear Search와 비교하여 엄청난 시간의 단축이 가능하다.
- 시간복잡도 = O(logN)
